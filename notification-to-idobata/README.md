...
```bash
notification-to-idobata$ sam build --use-container
```
...
```bash
notification-to-idobata$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
notification-to-idobata$ sam logs -n HelloWorldFunction --stack-name notification-to-idobata --tail
```
...
```bash
notification-to-idobata$ pip install pytest pytest-mock --user
notification-to-idobata$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name notification-to-idobata
```
